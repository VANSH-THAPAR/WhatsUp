    ...
    <div className="min-h-screen bg-zinc-950 text-white overflow-x-hidden selection:bg-green-500/30">
      ...
      <section className="py-20 md:py-32 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-16">
            <motion.div 
              style={{ x: useTransform(useScroll().scrollYProgress, [0.3, 0.8], [-50, 0]) }}
              className="flex-1 text-center md:text-left"
            >
               <h2 className="text-3xl md:text-4xl lg:text-6xl font-bold mb-6">Built for <span className="text-green-400">Speed</span></h2>
            ...
            <div className="flex-1 perspective-1000 w-full">
               <motion.div
                  ...
                  className="bg-zinc-900/50 border border-zinc-700 p-6 md:p-8 rounded-3xl backdrop-blur-xl shadow-2xl skew-y-3 mx-auto max-w-lg"
               >
      ...
      <section className="py-12 md:py-20 pb-20 md:pb-32 overflow-hidden">
        <div className="container mx-auto px-4">
            <motion.div 
                ...
                className="relative w-full rounded-[2rem] md:rounded-[3rem] overflow-hidden bg-gradient-to-r from-green-900 to-emerald-900 border border-green-500/30 p-8 md:p-12 lg:p-24 text-center perspective-1000 transform-style-3d group"
            >
                ...
                <div className="relative z-10" style={{ transform: "translateZ(60px)" }}>
                    <h2 className="text-3xl md:text-4xl lg:text-6xl font-bold mb-4 md:mb-8 text-white drop-shadow-xl">Ready to Dive In?</h2>
                    <p className="text-emerald-100 text-base md:text-lg lg:text-xl mb-8 md:mb-12 max-w-2xl mx-auto drop-shadow-md">
                        Join thousands of users who have already switched to the most immersive chat platform on the web.
                    </p>
                    <button 
                        onClick={() => navigate('/signup')} 
                        className="px-8 py-4 md:px-10 md:py-5 bg-white text-emerald-900 font-bold text-lg md:text-xl rounded-full hover:bg-zinc-200 transition-all shadow-[0_0_50px_rgba(255,255,255,0.3)] hover:scale-105 active:scale-95"
                    >
                        Create Free Account
                    </button>
                </div>
